...
// KeyData contains all encryption keys for different algorithms
var (
	// CAFBCBAD-B6E7-4CAB-8A67-14D39F00CE1E (AES/CBC/NoPadding)
	Key1_CAFBCBAD = []byte{
	...
	// A474B1C2-3DE0-4EA2-8C5F-7093409CE6C4 (AES/ECB/NoPadding)
	Key1_A474B1C2 = []byte{
	...
	// 5BFBA864-BBA9-42DB-8EAD-49B5F412BD81 (DESede/CBC/NoPadding)
	Key1_5BFBA864 = []byte{
	...
	// 6E0B65FF-0B5B-459C-8FCE-EC7F2BEA9FF5 (DESede/ECB/NoPadding)
	Key1_6E0B65FF = []byte{
	...
	// F3974434-C0DD-4C20-9E87-DDB6814A1C48 (SM4/CBC/PKCS5Padding)
	Key_F3974434 = []byte{
	...
	// B3047D4E-67DF-4864-A6A5-DF9B9E525C79 (XTEA Non-standard)
	Key1_B3047D4E = []uint32{
		0x7a7a676a, 0x277e4a73, 0x3e43296c, 0x577d7d7a,
	}
	Key2_B3047D4E = []uint32{
		0x3d3c695f, 0x71797a74, 0x445f5763, 0x6f692765,
	}
	Key3_B3047D4E = []uint32{
		0x5b5a683d, 0x2e572a77, 0x4a474465, 0x663d7e5c,
	}

	// C32C68F9-CA81-4260-A329-BBAFD1A9CCD1 (XTEA-IV Non-standard)
	Key1_C32C68F9 = []uint32{
		0x796d7855, 0x297b2355, 0x587d726e, 0x4d3d4423,
	}
	Key2_C32C68F9 = []uint32{
		0x7c70525d, 0x5a585d3d, 0x413e4029, 0x28755d6a,
	}
	Key3_C32C68F9 = []uint32{
